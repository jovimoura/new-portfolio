        ...
        <div className="w-full relative pb-20 py-10 z-40">
            ...
            >
                <div className="w-full">
                    ...
                    A creative problem solver with over 5 years of programming experience, I&apos;ve explored diverse programming languages, libraries, and technology stacks, honing my skills in both Frontend, Backend, and App development.
                    </p>
